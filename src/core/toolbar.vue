<template>
  <div class="toolbar flex align-center justify-space-between">
    ...
    <div class="box-right flex align-center pl-10">
      <el-dropdown trigger="click" @command="onCommandLang">
        ...
        <el-dropdown-menu slot="dropdown">
          <el-dropdown-item command="us">
            <i class="flag-icon flag-icon-us mr-15"></i>English
          </el-dropdown-item>
          <el-dropdown-item command="it">
            <i class="flag-icon flag-icon-it mr-15"></i>Italian
          </el-dropdown-item>
          <el-dropdown-item command="fr">
            <i class="flag-icon flag-icon-fr mr-15"></i>French
          </el-dropdown-item>
          <el-dropdown-item command="de">
            <i class="flag-icon flag-icon-de mr-15"></i>German
          </el-dropdown-item>
          <el-dropdown-item command="es">
            <i class="flag-icon flag-icon-es mr-15"></i>Spanish
          </el-dropdown-item>
          <el-dropdown-item command="cn">
            <i class="flag-icon flag-icon-cn mr-15"></i>Chinese
          </el-dropdown-item>
          <el-dropdown-item command="jp">
            <i class="flag-icon flag-icon-jp mr-15"></i>Japanese
          </el-dropdown-item>
      ...
      <span class="username">
        <router-link to="/profile">Aurora Shenton</router-link>
      </span>
      <el-dropdown trigger="click" @command="onCommand">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item command="/contacts">
            <i class="mdi mdi-account-multiple mr-10"></i> Contacts
          </el-dropdown-item>
